...
namespace people {
    ...
    Client::Client(std::string email_, std::string name_, std::string phone_, std::string deal_product_)
    ...
    Manager::Manager(std::string email_, std::string password_, std::string name_, std::string phone_)
